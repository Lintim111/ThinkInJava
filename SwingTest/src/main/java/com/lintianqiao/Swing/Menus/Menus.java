package com.lintianqiao.Swing.Menus;

import javax.swing.*;
import java.awt.*;
import java.awt.event.*;

import static com.lintianqiao.Swing.SwingConsole.SwingConsole.run;

public class Menus extends JFrame {

    private String[] flavors = {"Chocolate", "Strawberry", "Swirl", "Chip", "Fudge", "Raisin", "Cream", "Pie"};
    ...
    class ML implements ActionListener {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            String actionCommend = target.getActionCommand();
            if (actionCommend.equals("Open")) {
                String s = t.getText();
                ...
                if (!chosen) {
                    t.setText("Chose a flavor first");
                } else {
