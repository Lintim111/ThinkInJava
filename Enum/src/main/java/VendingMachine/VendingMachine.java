...
import VendingMachine.Utils.Generator;
import VendingMachine.Utils.TextFile;

import java.util.*;

import VendingMachine.Input;

import static VendingMachine.Input.*;


enum Category {
    MONEY(DIME, QUARTER, DOLLAR),
